...
int main(int argc, char *argv[]) {
    ...
    hst_rslt.create_all(in.arguments.chosen_method, MethodStrategy::EXHAUSTIVE, static_cast<uint32_t>(in.gather.cdps.size()), in.gather.nsmpl_per_trce);
